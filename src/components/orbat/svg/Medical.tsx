...
export default function Medical({ bg = "#b3d9ff", stroke = "#111827", shape = "#111827", className, title }: OrbatSVGProps) {
    return (
        <svg className={className} aria-label={title} role="img" preserveAspectRatio="xMidYMid meet" width="100%" height="100%"
            ...
            <g id="l" data-name="Anti-Air">
                ...
                <g id="j" data-name="_x3C_Ecrêter_le_groupe_x3E__Medical">
                    <line x1="128" y1="8" x2="128" y2="184" fill="none" stroke={shape} strokeLinecap="round" strokeMiterlimit="10" strokeWidth="8" />
                    <line x1="248" y1="96" x2="8" y2="96" fill="none" stroke={shape} strokeLinecap="round" strokeMiterlimit="10" strokeWidth="8" />
                </g>
