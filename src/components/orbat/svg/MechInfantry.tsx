...
export default function MechInfantry({ bg = "#b3d9ff", stroke = "#111827", shape = "#111827", className, title }: OrbatSVGProps) {
    return (
        <svg className={className} aria-label={title} role="img" preserveAspectRatio="xMidYMid meet" width="100%" height="100%"
            ...
            <g id="g" data-name="Armored-Infantry">
                <g id="h" data-name="_x3C_Rectangle_x3E__fond">
                    <rect y="0" width="256" height="192" fill={bg} />
                </g>
                <g id="i" data-name="_x3C_Rectangle_x3E__rectangle_int.">
                ...
                <g id="j" data-name="_x3C_Rectangle_arrondi_x3E_">
                ...
                <g id="k" data-name="_x3C_Rectangle_x3E__bord_ext._contour">
