...
export default function Recon({ bg = "#b3d9ff", stroke = "#111827", shape = "#111827", className, title }: OrbatSVGProps) {
    return (
        <svg className={className} aria-label={title} role="img" preserveAspectRatio="xMidYMid meet" width="100%" height="100%"
            ...
            <g id="c" data-name="Recon">
                <g id="d" data-name="_x3C_Rectangle_x3E__fond">
                    <rect width="256" height="192" fill={bg} />
                </g>
                <g id="e" data-name="_x3C_Rectangle_x3E__rectangle_int.">
                ...
                <g id="f" data-name="_x3C_Rectangle_x3E__bord_ext._contour">
