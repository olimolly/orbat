...
export default function Supply({ bg = "#b3d9ff", stroke = "#111827", shape = "#111827", className, title }: OrbatSVGProps) {
    return (
        <svg className={className} aria-label={title} role="img" preserveAspectRatio="xMidYMid meet" width="100%" height="100%"
            ...
            <g id="l" data-name="Anti-Air">
                ...
                <g id="y" data-name="_x3C_Tracé_x3E__Supply">
                    <polyline points="8 144.716 8 144.715 248 144.715 248 144.716" fill="none" stroke={shape} strokeLinecap="round" strokeMiterlimit="10" strokeWidth="8" />
                </g>
